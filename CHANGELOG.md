...
- [#147](https://github.com/toiroakr/karinto/pull/147) [`a5e14e3`](https://github.com/toiroakr/karinto/commit/a5e14e374412af0ee8492c78f4e828cadbf8afeb) Thanks [@toiroakr](https://github.com/toiroakr)! - Add `cache-mode` to the allowed workflow top-level and job-level keys for the
