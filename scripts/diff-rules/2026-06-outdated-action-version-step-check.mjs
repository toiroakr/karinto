...
// Only suppress diffs where the PR adds new outdated-action-version diagnostics
// and nothing is removed (onlyInCaptured must be empty).
function isOutdatedActionVersion(x) {
  return x.rule === "outdated-action-version";
}
